...
class Window(QWidget):
    ...
    def save_current_file(self):
        if not self.file_path:
            new_file_path, filter_type = QFileDialog.getSaveFileName(self, "Save this fileas...", "", "All files (*)")
            if new_file_path:
    ...
    def closeEvent(self, event):
        ...
        message = "WARNING !!\n\nIf you quit without saving, any changes made to the filewill be lost.\n\nSave file before quitting?"
    ...
    def invalid_path_alert_message(self):
        ...
        messageBox.setText("Selected filename or path is not valid. Please select valid file.")
        messageBox.exec()
